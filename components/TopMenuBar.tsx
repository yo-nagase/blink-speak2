          ...
          <nav className="hidden md:flex items-center space-x-1">
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" size="default" className="">Products <ChevronDown className="ml-1 h-3 w-3" /></Button>
              </DropdownMenuTrigger>
              <DropdownMenuContent>
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" size="default" className="">Solutions <ChevronDown className="ml-1 h-3 w-3" /></Button>
              </DropdownMenuTrigger>
              <DropdownMenuContent>
            ...
            <Button variant="ghost" size="default" className="">Resources</Button>
            <Button variant="ghost" size="default" className="">Enterprise</Button>
            <Button variant="ghost" size="default" className="">Docs</Button>
            <Button variant="ghost" size="default" className="">Pricing</Button>
          </nav>
        </div>
        <div className="flex items-center space-x-2">
          <ModeToggle />
          <Button variant="ghost" size="sm">Log In</Button>
          <Button size="sm" className="bg-red-300 dark:bg-green-300">Contact</Button>
